package dev.gaphunter.phpopenredirectcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.phpopenredirectcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.phpopenredirectcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "PHP Open Redirect Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33891-php-open-redirect-companion/reviews"
